...
class PotatoTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "PotatoCell", for: indexPath) as! PotatoTableViewCell
        cell.typeLabel.text = Potato.potatoArr[indexPath.row].type
        cell.potatoImageView?.image = Potato.potatoArr[indexPath.row].image
